...
public class UserHandler {
    ...
    public void updateUser(Context c) throws IOException {
        ...
        try {
            ...
            else if(!(req.getRole_id().equals("E")||req.getRole_id().equals("M")||req.getRole_id().equals("A"))) throw new InvalidAuthException("Must enter a role of 'M' for manager, 'A' for admin, 'E' for employee, or one of 'Deny, Denied, or Delete' to deny and delete the record." );
